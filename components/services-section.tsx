...
export function ServicesSection() {
  ...
  return (
    <section
      ...
      className="border-t border-white/10 bg-white/[0.018] py-16 sm:py-20"
    >
      <Container>
        ...
        >
          {services.map((service) => (
            ...
            >
              ...
              />
              <div>
                <div className="mb-3.5 flex h-9 w-9 items-center justify-center rounded-lg border border-indigo-500/20 bg-indigo-500/10 text-indigo-400 transition-colors duration-300 group-hover:border-indigo-500/40 group-hover:bg-indigo-500/20">
              ...
              <ul className="mt-4 space-y-1.5 pl-4 text-xs leading-relaxed text-slate-300 list-disc marker:text-indigo-400 sm:text-sm">
